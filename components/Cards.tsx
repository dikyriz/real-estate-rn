...
export const Card = ({onPress}: Props) => {
    return (
        <TouchableOpacity onPress={onPress} className="flex-1 w-full mt-4 px-3 py-4 rounded-lg bg-white shadow-lg shadow-black-100/70 relative">
            <View className="flex flex-row items-center absolute px-2 top-5 bg-white/90 p-1 rounded-full z-50">
            ...
            <View className="flex flex-col mt-2">
                ...
                <Text className="text-xs font-rubik text-black-200">22 W 15th St, New York</Text>
